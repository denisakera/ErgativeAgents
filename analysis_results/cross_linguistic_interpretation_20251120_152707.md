...
**Agent Pattern**: Basque marks 0.0% of arguments with ergative (explicit agents). English has 83.2% agent-subject alignment.

**Patient Pattern**: Basque marks 0.0% with absolutive (patients). English uses 65.0% passive voice (agent obscuring).
...
- **Ergative Ratio**: 0.0%
- **Interpretation**: LOW (0.0% vs 35% baseline) - AI is using LESS explicit agent marking than typical Basque. This suggests the AI is AVOIDING clear agency attribution.

### English (Subject Position)
- **Agent-as-Subject Ratio**: 83.2%
- **Interpretation**: HIGH (83.2% vs 70% baseline) - AI is using MORE active voice constructions, making agents very explicit as subjects.
...
- **Interpretation**: HIGH passive voice (65.0%) - AI frequently obscures agents. Responsibility is diffused.

### Basque Absolutive Case
- **Absolutive Ratio**: 0.0%
- **Function**: Absolutive case marks PATIENTS (things affected by actions)

### Parallel Insight
**DIVERGENT PATTERN - Languages differ in agent vs patient focus. This suggests grammatical structure is influencing how AI frames the debate topic.**
...
- Zentsura justifikatzeko, askatasunaren eta segurtasunaren arteko oreka behar da. Baduzu puntua hitzaldiek gorrotoa sustatu edo indarkeriara bultzatzen...
- Zentsura gai delikatua da, eta, nire ustez, muturreko kasuetan bakarrik hartu beharko litzateke kontuan. Eztabaida ez da erraz konpontzen, baina hemen...
- Zentsura oso delikatua da, eta ados nago hitzaldi batzuk arriskutsuak izan daitezkeela. Gorrotoa sustatzen edo zuzenean indarkeriara bultzatzen duten ...

### English Active Voice Examples

- The argument for censorship often hinges on curbing harmful or dangerous speech, such as hate speech, incitement to violence, or obscenity. Proponents...
- The argument for censorship suggests it prevents societal harm by restricting hate speech or incitement. While this seems protective, it often leads t...

### English Passive Voice Examples (Agent Obscuring)

- The opposing argument suggests censorship ensures societal harmony and protects against harm, particularly through restrictions on hate speech or inci...
- The argument for censorship claims it prevents harm by limiting hate speech or violence incitement. While these goals appear noble, censorship risks b...
